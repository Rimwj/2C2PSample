...
function b64tohex(a) {
    ...
    for (c = 0; c < a.length && a.charAt(c) != b64padchar; ++c)
        ...
        v < 0 || (0 == d ? (b += int2char(v >> 2),
        e = 3 & v,
        d = 1) : 1 == d ? (b += int2char(e << 2 | v >> 4),
        e = 15 & v,
        d = 2) : 2 == d ? (b += int2char(e),
        b += int2char(v >> 2),
        e = 3 & v,
        d = 3) : (b += int2char(e << 2 | v >> 4),
        b += int2char(15 & v),
        d = 0));
    return 1 == d && (b += int2char(e << 2)),
    b
}
function b64toBA(a) {
...
!function(a) {
    "use strict";
    function d(a, c) {
        return a.length > c && (a = a.substring(0, c) + b),
        a
    }
    function e(a, b) {
    ...
    function g(a) {
        ...
        31 == this.tagNumber) {
            ...
            do {
                ...
                c += 7,
                c > 53)
                    throw "Tag numbers over 53 bits not supported at position " + (a.pos - 1);
    ...
    e.prototype.parseOctetString = function(a, c, e) {
        if (this.isASCII(a, c))
            return d(this.parseStringISO(a, c), e);
        var f = c - a
          , g = "(" + f + " byte)\n";
        e /= 2,
        f > e && (c = a + e);
    ...
    f.prototype.content = function(b) {
        ...
        if (!this.tag.isUniversal())
            return null !== this.sub ? "(" + this.sub.length + " elem)" : this.stream.parseOctetString(c, c + e, b);
        switch (this.tag.tagNumber) {
        case 1:
    ...
    f.decodeLength = function(a) {
        ...
        if (c == b)
            return c;
        if (c > 6)
            throw "Length over 48 bits not supported at position " + (a.pos - 1);
        if (0 === c)
            return null;
        b = 0;
        for (var d = 0; d < c; ++d)
    ...
    f.decode = function(a) {
        ...
        if (null === j) {
            if (null === d)
                throw "We can't skip over an invalid tag with undefined length at offset " + h;
            a.pos = h + Math.abs(d)
        }
...
function(a, b) {
    ...
    var a = 14
      ...
      , m = function(c, d) {
        ...
        i = h[0],
        k = 1; k < e; k++)
            h[k] = O(h[k - 1].concat(j)),
            i = i.concat(h[k]);
        return f = i.slice(0, 4 * b),
        g = i.slice(4 * b, 4 * b + 16),
        {
            key: f,
            iv: g
        }
      ...
      , n = function(a, b, c) {
        ...
        for (a.length % 16 === 0 && (e.push([16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16]),
        d++),
        g = 0; g < e.length; g++)
            e[g] = 0 === g ? v(e[g], c) : v(e[g], h[g - 1]),
            h[g] = p(e[g], b);
        return h
    }
      , o = function(a, b, c, d) {
      ...
      , s = function(a) {
        var e, b = [], d = c ? [0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3] : [0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11];
        for (e = 0; e < 16; e++)
            b[e] = a[d[e]];
        return b
    }
      , t = function(a) {
        ...
        if (c)
            for (d = 0; d < 4; d++)
                b[4 * d] = L[a[4 * d]] ^ J[a[1 + 4 * d]] ^ K[a[2 + 4 * d]] ^ I[a[3 + 4 * d]],
                b[1 + 4 * d] = I[a[4 * d]] ^ L[a[1 + 4 * d]] ^ J[a[2 + 4 * d]] ^ K[a[3 + 4 * d]],
                b[2 + 4 * d] = K[a[4 * d]] ^ I[a[1 + 4 * d]] ^ L[a[2 + 4 * d]] ^ J[a[3 + 4 * d]],
                b[3 + 4 * d] = J[a[4 * d]] ^ K[a[1 + 4 * d]] ^ I[a[2 + 4 * d]] ^ L[a[3 + 4 * d]];
        else
            for (d = 0; d < 4; d++)
                b[4 * d] = G[a[4 * d]] ^ H[a[1 + 4 * d]] ^ a[2 + 4 * d] ^ a[3 + 4 * d],
                b[1 + 4 * d] = a[4 * d] ^ G[a[1 + 4 * d]] ^ H[a[2 + 4 * d]] ^ a[3 + 4 * d],
                b[2 + 4 * d] = a[4 * d] ^ a[1 + 4 * d] ^ G[a[2 + 4 * d]] ^ H[a[3 + 4 * d]],
                b[3 + 4 * d] = H[a[4 * d]] ^ a[1 + 4 * d] ^ a[2 + 4 * d] ^ G[a[3 + 4 * d]];
        return b
    }
      , u = function(a, b, c) {
        var e, d = [];
      ...
      , w = function(c) {
        var f, g, h, j, d = [], e = [], i = [];
        for (f = 0; f < b; f++)
            g = [c[4 * f], c[4 * f + 1], c[4 * f + 2], c[4 * f + 3]],
            d[f] = g;
        for (f = b; f < 4 * (a + 1); f++) {
            for (d[f] = [],
            h = 0; h < 4; h++)
      ...
      , O = function(a) {
        ...
        var o, p, q, r, s, t, u, v, w, n = [], x = z("", 8);
        for (n = l(a),
        t = x[0],
        u = x[1],
        v = x[2],
        ...
        o = 0; o < n.length; o += 16)
            ...
            r = v,
            s = w,
            t = h(t, u, v, w, n[o + 0], 7, x[4]),
            w = h(w, t, u, v, n[o + 1], 12, x[5]),
            v = h(v, w, t, u, n[o + 2], 17, x[6]),
            u = h(u, v, w, t, n[o + 3], 22, x[7]),
            t = h(t, u, v, w, n[o + 4], 7, x[8]),
            w = h(w, t, u, v, n[o + 5], 12, x[9]),
            v = h(v, w, t, u, n[o + 6], 17, x[10]),
            u = h(u, v, w, t, n[o + 7], 22, x[11]),
            t = h(t, u, v, w, n[o + 8], 7, x[12]),
            w = h(w, t, u, v, n[o + 9], 12, x[13]),
            v = h(v, w, t, u, n[o + 10], 17, x[14]),
            u = h(u, v, w, t, n[o + 11], 22, x[15]),
            t = h(t, u, v, w, n[o + 12], 7, x[16]),
            w = h(w, t, u, v, n[o + 13], 12, x[17]),
            v = h(v, w, t, u, n[o + 14], 17, x[18]),
            u = h(u, v, w, t, n[o + 15], 22, x[19]),
            t = i(t, u, v, w, n[o + 1], 5, x[20]),
            w = i(w, t, u, v, n[o + 6], 9, x[21]),
            v = i(v, w, t, u, n[o + 11], 14, x[22]),
            u = i(u, v, w, t, n[o + 0], 20, x[23]),
            t = i(t, u, v, w, n[o + 5], 5, x[24]),
            w = i(w, t, u, v, n[o + 10], 9, x[25]),
            v = i(v, w, t, u, n[o + 15], 14, x[26]),
            u = i(u, v, w, t, n[o + 4], 20, x[27]),
            t = i(t, u, v, w, n[o + 9], 5, x[28]),
            w = i(w, t, u, v, n[o + 14], 9, x[29]),
            v = i(v, w, t, u, n[o + 3], 14, x[30]),
            u = i(u, v, w, t, n[o + 8], 20, x[31]),
            t = i(t, u, v, w, n[o + 13], 5, x[32]),
            w = i(w, t, u, v, n[o + 2], 9, x[33]),
            v = i(v, w, t, u, n[o + 7], 14, x[34]),
            u = i(u, v, w, t, n[o + 12], 20, x[35]),
            t = j(t, u, v, w, n[o + 5], 4, x[36]),
            w = j(w, t, u, v, n[o + 8], 11, x[37]),
            v = j(v, w, t, u, n[o + 11], 16, x[38]),
            u = j(u, v, w, t, n[o + 14], 23, x[39]),
            t = j(t, u, v, w, n[o + 1], 4, x[40]),
            w = j(w, t, u, v, n[o + 4], 11, x[41]),
            v = j(v, w, t, u, n[o + 7], 16, x[42]),
            u = j(u, v, w, t, n[o + 10], 23, x[43]),
            t = j(t, u, v, w, n[o + 13], 4, x[44]),
            w = j(w, t, u, v, n[o + 0], 11, x[45]),
            v = j(v, w, t, u, n[o + 3], 16, x[46]),
            u = j(u, v, w, t, n[o + 6], 23, x[47]),
            t = j(t, u, v, w, n[o + 9], 4, x[48]),
            w = j(w, t, u, v, n[o + 12], 11, x[49]),
            v = j(v, w, t, u, n[o + 15], 16, x[50]),
            u = j(u, v, w, t, n[o + 2], 23, x[51]),
            t = k(t, u, v, w, n[o + 0], 6, x[52]),
            w = k(w, t, u, v, n[o + 7], 10, x[53]),
            v = k(v, w, t, u, n[o + 14], 15, x[54]),
            u = k(u, v, w, t, n[o + 5], 21, x[55]),
            t = k(t, u, v, w, n[o + 12], 6, x[56]),
            w = k(w, t, u, v, n[o + 3], 10, x[57]),
            v = k(v, w, t, u, n[o + 10], 15, x[58]),
            u = k(u, v, w, t, n[o + 1], 21, x[59]),
            t = k(t, u, v, w, n[o + 8], 6, x[60]),
            w = k(w, t, u, v, n[o + 15], 10, x[61]),
            v = k(v, w, t, u, n[o + 6], 15, x[62]),
            u = k(u, v, w, t, n[o + 13], 21, x[63]),
            t = k(t, u, v, w, n[o + 4], 6, x[64]),
            w = k(w, t, u, v, n[o + 11], 10, x[65]),
            v = k(v, w, t, u, n[o + 2], 15, x[66]),
            u = k(u, v, w, t, n[o + 9], 21, x[67]),
            t = c(t, p),
            u = c(u, q),
            v = c(v, r),
            w = c(w, s);
        ...
        var a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
          ...
          , c = function(a, c) {
            ...
            for (f = 0; f < d.length; f += 3)
                e += b[d[f] >> 2],
                e += b[(3 & d[f]) << 4 | d[f + 1] >> 4],
                e += void 0 !== d[f + 1] ? b[(15 & d[f + 1]) << 2 | d[f + 2] >> 6] : "=",
                e += void 0 !== d[f + 2] ? b[63 & d[f + 2]] : "=";
            for (g = e.slice(0, 64) + "\n",
...
My2c2p.getEncryptedData = function(a, b) {}
,
My2c2p.onSubmitFormWithReturn = function(a, b, c) {
    var d = this
      ...
      , f = function(a) {
        ...
        for (c = 0; c < a.children.length; c++)
            child = a.children[c],
            1 === child.nodeType && child.attributes["data-encrypt"] ? b.push(child) : child.children.length > 0 && (b = b.concat(f(child)));
        return b
    }
      , g = function(a) {
        for (var b = {
      ...
      , l = function(a) {
        var c, d, e, f, b = [];
        if ("INTEGER" === a.typeName() && (c = a.posContent(),
        d = a.posEnd(),
        e = a.stream.hexDump(c, d),
        e = e.replace(/[ \n]/g, ""),
        b.push(e)),
        null !== a.sub)
      ...
      , m = function(a) {
        ...
        var g = f[0]
          , h = f[1];
        "00" == g.substr(0, 2) && (g = g.substr(2)),
        "0" == h.substr(0, 1) && (h = h.substr(1));
        var i = new RSAKey;
        i.setPublic(g, h);
        var j = i.encrypt(a);
        return hex2b64(j)
      ...
      , n = function(a, b, c) {
        ...
        console.log(a.elements.namedItem(b)),
    ...
    var o = function(a) {
        ...
        for (e = "",
        b = 0; b < a.length; b++)
            d = parseInt(a.charAt(b), 10),
            d >= 0 && d <= 9 && (e = d + e);
        if (e.length <= 1)
            return !1;
        for (f = "",
        b = 0; b < e.length; b++)
            d = parseInt(e.charAt(b), 10),
            b % 2 != 0 && (d *= 2),
            f += d;
        for (c = 0,
        b = 0; b < f.length; b++)
      ...
      , p = function(a) {
        ...
        var f = g(a)
          ...
          , j = !1;
        if (d.isEmpty(f.cardnumber) && d.isEmpty(f.month) && d.isEmpty(f.year) || (j = !0),
        j) {
            if (d.isEmpty(f.cardnumber))
                return 1;
            if (d.isEmpty(f.month))
                return 3;
            if (d.isEmpty(f.year))
                return 5;
            if (!o(f.cardnumber))
                return 2;
            if (f.month.length > 2 || f.month.length < 1)
                return 4;
            if (d.isEmpty(f.year))
                return 5;
            if (4 != f.year.length)
            ...
            if (i == c) {
                ...
                if ("0000" == f.year && "00" != f.month)
                    return 9;
                if ((h < 1 || h > 12) && "00" != f.month)
                    return 9
            }
            if (!f.cvv.match(/^[0-9]{3,4}$/) && !d.isEmpty(f.cvv))
                return 10
        } else if (d.isEmpty(f.cvv))
            ;
        else if (!f.cvv.match(/^[0-9]{3,4}$/) && !d.isEmpty(f.cvv))
            return 10;
        return 0
    }
      , q = function(a) {
      ...
      , r = function(a) {
        ...
        var y = x + e + v;
        y = y.replace("\n", ""),
        n(a, "encryptedCardInfo", y),
        n(a, "maskedCardInfo", i),
        n(a, "expMonthCardInfo", l),
        n(a, "expYearCardInfo", o)
    }
      , a = extractForm(a);
    d.callbackForm = function(b) {
        var e = p(a);
        0 != e ? ("" != b && b.preventDefault(),
        c ? c(e, d.errorDescription(e)) : alert(d.errorDescription(e))) : (r(a),
        c && c(0, ""))
    }
    ,
